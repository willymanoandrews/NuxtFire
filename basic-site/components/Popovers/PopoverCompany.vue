    ...
    <div class="p-3">
        <div class="flex">
            <div class="me-3 shrink-0">
                ...
                <img class="w-8 h-8 rounded-full" src="https://via.placeholder.com/80" alt="Company logo">
            </a>
            </div>
            <div>
                <p class="mb-1 text-base font-semibold leading-none text-gray-900 dark:text-white">
                    <a href="#" class="hover:underline">Company Name</a>
                </p>
                ...
                <ul class="text-sm">
                    <li class="flex items-center mb-2">
                        ...
                        <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline">https://company.com/</a>
                    </li>
                ...
                <div class="flex mb-3 -space-x-3 rtl:space-x-reverse">
                    <img class="w-8 h-8 border-2 border-white rounded-full dark:border-gray-800" src="https://via.placeholder.com/64" alt="">
                    <img class="w-8 h-8 border-2 border-white rounded-full dark:border-gray-800" src="https://via.placeholder.com/64" alt="">
                    <img class="w-8 h-8 border-2 border-white rounded-full dark:border-gray-800" src="https://via.placeholder.com/64" alt="">
...
// Initialize only the Popover component
onMounted(() => {
    useFlowbite(() => {
        initPopovers();
    });
