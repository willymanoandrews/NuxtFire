    ...
    <form class="mb-6">
      ...
      <div class="mb-4">
        ...
        <div class="relative">
          ...
          <button
            type="button"
            class="absolute inline-flex items-center px-3 py-1 text-sm font-medium text-white bg-blue-700 rounded-lg end-2 bottom-2 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <svg
...
// Initialize only the Drawer component
onMounted(() => {
    useFlowbite(() => {
        initDrawers();
    });
